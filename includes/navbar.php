                            ...
                            <div class="main-menu f-right">
                                <nav id="mobile-menu" style="display: block;">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="course_01.html">Formations</a>
                                            <ul class="submenu">
                                                <li>
                                                    <a href="Développement/index.php">Développement</a>
                                                </li>
                                                <li>
                                                    <a href="cloud&computing/index.php">Cloud&Computing</a>
                                                </li>
                                                <li>
                                                    <a href="DevOps/index.php">Devops</a>
                                                </li>
                                                <li>
                                                    <a href="formation_acceleres/index.php">Formations accélérées</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
