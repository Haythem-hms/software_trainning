                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider-content slider-content-breadcrumb text-center">
                                <h1 class="white-color f-700">Blog</h1>
                                <nav class="text-center" aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item"><a href="../index.php">Accueil</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Parcours du développeur web</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="single-course-details-area mb-30">
                        ...
                        <div class="single-course-details white-bg">
                            <div class="course-details-title mb-20">
                                <h1>Se reconvertir dans le développement web : le parcours et les conseils.</h1>
                            </div>
